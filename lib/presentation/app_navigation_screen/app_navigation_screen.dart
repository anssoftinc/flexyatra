                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          screenTitle: "Meal Plan Page - Container".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
                              AppRoutes.mealPlanPageContainerScreen),
                        ),
                        _buildScreenTitle(
                          screenTitle: "Tracker Page - Tab Container".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
                              AppRoutes.trackerPageTabContainerScreen),
                        ),
                        _buildScreenTitle(
                          screenTitle: "Workout Plan Page".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.workoutPlanPageScreen),
                        ),
                        _buildScreenTitle(
